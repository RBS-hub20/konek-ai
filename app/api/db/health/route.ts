...
const COLUMN_TYPES: Record<string, string> = {
  ...
  handoff_number: 'text',
  handoff_backup: 'text',
  handoff_mode: "text default 'on_request'",
...
const EXPECTED: Record<string, string[]> = {
  ...
  services: ['id', 'business_id', 'name', 'price', 'description', 'duration', 'category', 'is_active', 'sort_order'],
  leads: ['id', 'company', 'contact_person', 'phone', 'industry', 'country', 'status', 'call_count', 'last_called_at', 'twilio_sid'],
